...
The application is developed using [Qt Creator](https://qt-project.org/) and [MinGW-w64](http://mingw-w64.sourceforge.net/). It should be possible to compile it with other compilers but changing the IDE may require recreating the project file. Currently .pro and .pri files are used with qmake. 
