...
namespace {
    /**
     * @brief LCG pseudo random number generator.
     * @param seed The seed.
     * @return The pseudo random number.
     */
    long long lcgRand(long long seed)
    {
        // Calculate pseudo random number using Knuths algorithm.
        return seed * 6364136223846793005l + 1442695040888963407l;
    }

    /**
     * @brief Since 3D has 24 gradients, simple bitmask won't work, so precompute modulo array.
     * @param baseValue The base value.
     * @param numGradients Number of values in 3D gradient array.
     * @return The 3D gradient value.
     */
    short gradientValue3D(short baseValue, int numGradients)
    {
        return static_cast<short>((baseValue % (numGradients / 3)) * 3);
    }
}
...
frts::OpenSimplexNoise::~OpenSimplexNoise()
{}

double frts::OpenSimplexNoise::eval(double x, double y) const
{
...
double frts::OpenSimplexNoise::eval(double x, double y, double z) const
{
...
double frts::OpenSimplexNoise::eval(double x, double y, double z, double w) const
{
    // Place input coordinates on simplectic honeycomb.
...
double frts::OpenSimplexNoise::extrapolate(int xsb, int ysb, int zsb, int wsb, double dx, double dy, double dz, double dw) const
{
    ...
    return gradients4D.at(index) * dx +
           ...
           gradients4D.at(index + 3) * dw;
}

int frts::OpenSimplexNoise::fastFloor(double x) const
{
